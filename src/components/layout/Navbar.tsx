          ...
          {profileOpen && (
            <div className="absolute top-full right-0 mt-2 w-64 bg-[#0f172a] border border-slate-800/80 rounded-xl shadow-2xl p-3 z-50 backdrop-blur-md">
              ...
              <div className="flex flex-col gap-1">
                <a href="https://docs.trujillomingorance.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between px-2 py-1.5 text-sm text-slate-300 hover:bg-slate-800/50 hover:text-white rounded-lg transition-colors">
                  <span>ATM DOCS</span>
